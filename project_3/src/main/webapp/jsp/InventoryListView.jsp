			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<input type="text" name="quantity" placeholder="Enter quantity"
						...
						maxlength="10" oninput="handleIntegerInput(this, 'quantityError', 3)"
				...
				&emsp; &emsp;
				<div class="col-sm-2">
					<input type="text" name="lastUpatedDate" id="datepicker2" 
						placeholder="Enter lastUpatedDate" class="form-control" readonly="readonly"
