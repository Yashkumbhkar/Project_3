				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>AllowedSpeed</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" class="form-control" name="allowedSpeed"
											...
											oninput="handleIntegerInput(this, 'allowedSpeedError', 7)"
											onblur="validateIntegerInput(this, 'allowedSpeedError', 7)"
					...
					: DataUtility.getStringData(dto.getAllowedSpeed())%>">
								...
								<font color="red" class="pl-sm-5" id="allowedSpeedError">
									<%=ServletUtility.getErrorMessage("allowedSpeed", request)%></font></br>
