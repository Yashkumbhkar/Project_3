			...
			<div class="row">
				...
				<!-- <div class="col-sm-2"></div> -->
					...
					<input type="text" name="paymentTerm" placeholder="Enter paymentTerm"
						...
						maxlength="10" oninput="handleIntegerInput(this, 'paymentTermError', 6)"
				...
				<div class="col-sm-2">
					<input type="text" id= "datepicker2" name="registrationDate" placeholder="Enter registrationDate"
