...
<body class="hm">
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Update Loans</h3>
							<%
								} else {
							%>
							<h3 class="text-center default-text text-primary">Add Loans</h3>
							<%
								}
							%>
							<!--Body-->
							<div>
							 ...
							 HashMap map1 = (HashMap)	request.getAttribute("sm");
								%>
	...
	<span class="pl-sm-5"><b>Loans_Start_date</b>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" id="datepicker2" name="loanStartDate" class="form-control" placeholder="loanStartDate " readonly="readonly" value="<%=DataUtility.getDateString(dto.getLoanStartDate()) %>">
      </div>
    </div>	
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("loanStartDate", request)%></font></br>	<%-- 
								<%
								if (dto.getId()==null||id<=0) {
								%> --%>

<span class="pl-sm-5"><b>Loans_Amount</b> <span
									...
									<div class="col-sm-12">
										<div class="input-group">
											...
											<input type="text" class="form-control" name="loanAmount"
												...
												oninput="handleIntegerInput(this, 'loanAmountError', 8)"
												onblur="validateIntegerInput(this, 'loanAmountError', 8)"
												value="<%=DataUtility.getStringData(dto.getLoanAmount()).equals("0") ? ""
					: DataUtility.getStringData(dto.getLoanAmount())%>">

										</div>
									</div>
									<font color="red" class="pl-sm-5" id="loanAmountError"> <%=ServletUtility.getErrorMessage("loanAmount", request)%></font></br>


							
								<span class="pl-sm-5"><b>intrestRate(%)</b> <span
										style="color: red;">*</span></span> </br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
											...
											<input type="text" class="form-control" name="intrestRate"
												placeholder="Enter intrestRate"
												oninput="handleIntegerInput(this, 'intrestRateError', 4)"
												onblur="validateIntegerInput(this, 'intrestRateError', 4)"
												value="<%=DataUtility.getStringData(dto.getIntrestRate()).equals("0") ? ""
					: DataUtility.getStringData(dto.getIntrestRate())%>">

										</div>
									</div>
									<font color="red" class="pl-sm-5" id="intrestRateError"> <%=ServletUtility.getErrorMessage("intrestRate", request)%></font></br>
	...
	<span class="pl-sm-5"><b>Customer_id</b><span style="color: red;">*</span></span> </br>
      ...
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text"><i class="fa fa-venus-mars grey-text" style="font-size: 1rem;"></i> </div>
									...
									<%
									String htmlList = HTMLUtility.getList("customerId", dto.getCustomerId(), map1);
									%>
									<%=htmlList%></div>
    </div>		
