			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="intrestRate" placeholder="Enter intrestRate"
						...
						maxlength="10" oninput="handleIntegerInput(this, 'intrestRateError', 3)"
						onblur="validateIntegerInput(this, 'intrestRateError', 3)"
				...
				<div class="col-sm-2">
						...
						class="form-control" onkeypress="ValidateKey(event)"
						maxlength="10" oninput="handleIntegerInput(this, 'loanAmountError', 8)"
						onblur="validateIntegerInput(this, 'loanAmountError', 8)"
						value="<%=ServletUtility.getParameter("loanAmount", request)%>">
						
					<font color="red" class="pl-sm-5" id="loanAmountError"></font>
</div>
				&emsp;
				<div class="col-sm-2"><%=HTMLUtility.getList("customerId",dto.getCustomerId(), map)%></div>
				&emsp; &emsp;
				<div class="col-sm-2">
					<input type="text" id="datepicker2" name="loanStartDate" class="form-control"
						placeholder="Enter loanStartDate" readonly="readonly"
