			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="experience" placeholder="Enter Experience"
						class="form-control"
						oninput="handleLetterInput(this, 'experienceError', 100)"
						onblur="validateLetterInput(this, 'experienceError', 100)"
				...
				<div class="col-sm-2">
					<input type="text" name="title" placeholder="Enter title"
						class="form-control"
						oninput="handleLetterInput(this, 'titleError', 30)"
						onblur="validateLetterInput(this, 'titleError', 30)"
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=DataUtility.getDateString(dto.getOpeningJob())%></td>
