									...
									<div class="col-sm-12">
										<div class="input-group">
											...
											<input type="text" class="form-control" name="name"
												...
												placeholder="Enter supplierName" value="<%=DataUtility.getStringData(dto.getName())%>"
									...
									<div class="col-sm-12">
										<div class="input-group">
											...
											<input type="text" class="form-control" name="paymentTerm"
												...
												oninput="handleIntegerInput(this, 'paymentTermError', 6)"
												onblur="validateIntegerInput(this, 'paymentTermError', 6)"
												value="<%=DataUtility.getStringData(dto.getPaymentTerm()).equals("0") ? ""
					: DataUtility.getStringData(dto.getPaymentTerm())%>">

										</div>
									</div>
									<font color="red" class="pl-sm-5" id="paymentTermError"> <%=ServletUtility.getErrorMessage("paymentTerm", request)%></font></br>
