								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="experience"
											...
											oninput="handleLetterInput(this, 'experienceError', 30)"
											onblur="validateLetterInput(this, 'experienceError', 30)"
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<textarea name="title" placeholder="Enter Title"
											class="form-control"
											oninput="handleLetterInput(this, 'titleError', 100)"
											onblur="validateLetterInput(this, 'titleError', 100)"
