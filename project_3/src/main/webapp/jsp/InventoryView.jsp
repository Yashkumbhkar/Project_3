							...
							<div class="md-form">
								...
								<div class="md-form">
									...
									<div class="col-sm-12">
										<div class="input-group">
											...
											<input type="text" class="form-control" name="supplierName"
												placeholder="Enter supplierName" id="supplierName"
												placeholder="Enter supplierName" value="<%=DataUtility.getStringData(dto.getSupplierName())%>"
									...
									<font color="red" class="pl-sm-5" id="supplierNameError">
										...
										class="pl-sm-5"><b>lastUpatedDate</b> <span
										style="color: red;">*</span></span></br>
									<div class="col-sm-12">
										<div class="input-group">
											<div class="input-group-prepend">
											...
											<input type="text" id="datepicker2" name="lastUpatedDate"
												class="form-control" placeholder=" Enter lastUpatedDate "
												readonly="readonly"
												value="<%=DataUtility.getDateString(dto.getLastUpatedDate())%>">
										</div>
									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("lastUpatedDate", request)%></font></br>
									<%-- 	<%
								if (dto.getId()==null||id<=0) {
								%> --%>
