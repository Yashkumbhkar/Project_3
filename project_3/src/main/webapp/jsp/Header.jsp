...
<body>
 ...
 --%>
	...
	<%-- <li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Vechicle</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.VECHICLE_CTL%>"> <i
							class="fas fa-user-circle"></i>Add Vechicle
						</a> <a class="dropdown-item" href="<%=ORSView.VECHICLE_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>vechicle List</a>
					</div></li> --%>
...
<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Loans</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.LOANS_CTL%>"> <i
							class="fas fa-user-circle"></i>Add Loans
						</a> <a class="dropdown-item" href="<%=ORSView.LOANS_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Loans List</a>
					</div></li>
...
<%-- 	<li class="nav-item dropdown" style="padding-left: 5px"><a
			...
			<%-- 	<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Route</font>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.TRANSPORTATION_CTL%>"> <i
							class="fas fa-user-circle"></i>Add Transportation
					...
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Lead</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.LEAD_CTL%>"> <i
							class="fas fa-user-circle"></i>Add Lead
						</a> <a class="dropdown-item" href="<%=ORSView.LEAD_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Lead List</a>
					</div></li>
					   --%>
