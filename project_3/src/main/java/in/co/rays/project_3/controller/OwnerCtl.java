...
public class OwnerCtl extends BaseCtl{
	...
	protected void preload(HttpServletRequest request) {
		...
		map1.put("05/05/2002", "05/05/2002");
		map1.put("03/03/2000", "03/03/2000");
		map1.put("14/10/2002", "14/10/2002");
		map1.put("08/09/2001", "08/09/2001");
	...
	protected boolean validate(HttpServletRequest request) {
		...
		else if (Integer.parseInt(request.getParameter("insuranceAmount")) == 0) {
			request.setAttribute("insuranceAmount", " insuranceAmount must be contain 1 ");
