...
public class DataValidator {
	...
	public static boolean isQuentity(String roll) { // my method created

		String rollreg = "^(?:[1-9][0-9]{0,2}|[1-4][0-4]{2}|500)$";
	...
	public static boolean isPayment(String roll) { // my method created

		String rollreg = "^(?:[1-9][0-9]{0,3}|[1-4][0-9]{4}|50000)$\r\n" + 
				"";
